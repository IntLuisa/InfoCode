...
<template>
    ...
    <AuthenticationCard>
        <template #logo>
            <img src="/assets/images/template/logo.png" class="mb-4 h-40" />
        </template>

        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            <template v-if="!recovery">
                Por favor confirme o acesso a sua conta digitando o código de autenticação fornecido pelo seu aplicativo
                de autenticação.
            </template>

            <template v-else>
                Por favor confirme o acesso a sua conta digitando um dos seus códigos de recuperação.
            </template>
        </div>
